...
|8
|rocCurveData
|RocCurveData sequence
|-
|Данные точек ROC - кривых для каждого класса
|
|===
...
|ВАЖНО! Если длина значения данного поля превышает 255 символов, то оно обрезается до соответствующей длины
|4
|inputOptionsMap
...
==== 2.2.10. Описание полей блока RocCurveData
...
|2
|points
|RocCurvePoint sequence
|-
|Массив точек ROC - кривой для данного класса
|
|===

==== 2.2.11. Описание полей блока RocCurvePoint
...
|decimal
|-
|Координата x (100 - Specificity)
|
|2
|yValue
|decimal
|-
|Координата y (Sensitivity)
|
|3
|thresholdValue
|decimal
|-
|Значения порога в данной точке
|
|===
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
    ...
    <soapenv:Header/>
    <soapenv:Body>
        <evaluation:getEvaluationResultsSimpleRequest>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
    <SOAP-ENV:Header/>
    <SOAP-ENV:Body>
        <SOAP-ENV:getEvaluationResultsSimpleResponse>
            <SOAP-ENV:requestId>28d60dba-2130-49a5-9502-feae4f496638</SOAP-ENV:requestId>
            <SOAP-ENV:status>SUCCESS</SOAP-ENV:status>
            <SOAP-ENV:classifierReport>
                <SOAP-ENV:classifierName>CART</SOAP-ENV:classifierName>
                <SOAP-ENV:options>{"type":"decision_tree","decisionTreeType":"CART","minObj":2,"maxDepth":0,"randomTree":false,"numRandomAttr":0,"useBinarySplits":true,"useRandomSplits":false,"numRandomSplits":1,"seed":0,"additionalOptions":null}</SOAP-ENV:options>
                <SOAP-ENV:inputOptionsMap>
                    <SOAP-ENV:entry>
                        <SOAP-ENV:key>Случайное дерево:</SOAP-ENV:key>
                        <SOAP-ENV:value>false</SOAP-ENV:value>
            ...
            <SOAP-ENV:evaluationMethodReport>
                ...
                <SOAP-ENV:numFolds>3</SOAP-ENV:numFolds>
                <SOAP-ENV:numTests>1</SOAP-ENV:numTests>
                <SOAP-ENV:seed>1</SOAP-ENV:seed>
            </SOAP-ENV:evaluationMethodReport>
            <SOAP-ENV:statistics>
                <SOAP-ENV:numTestInstances>150</SOAP-ENV:numTestInstances>
                <SOAP-ENV:numCorrect>141</SOAP-ENV:numCorrect>
                <SOAP-ENV:numIncorrect>9</SOAP-ENV:numIncorrect>
                <SOAP-ENV:pctCorrect>94.0000</SOAP-ENV:pctCorrect>
                <SOAP-ENV:pctIncorrect>6.0000</SOAP-ENV:pctIncorrect>
                <SOAP-ENV:meanAbsoluteError>0.0507</SOAP-ENV:meanAbsoluteError>
                <SOAP-ENV:rootMeanSquaredError>0.1926</SOAP-ENV:rootMeanSquaredError>
                <SOAP-ENV:maxAucValue>0.9800</SOAP-ENV:maxAucValue>
                <SOAP-ENV:varianceError>0.0012</SOAP-ENV:varianceError>
                <SOAP-ENV:confidenceIntervalLowerBound>-0.0261</SOAP-ENV:confidenceIntervalLowerBound>
                <SOAP-ENV:confidenceIntervalUpperBound>0.1461</SOAP-ENV:confidenceIntervalUpperBound>
            </SOAP-ENV:statistics>
        </SOAP-ENV:getEvaluationResultsSimpleResponse>
    </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
